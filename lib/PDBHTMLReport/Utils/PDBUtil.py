...
class PDBUtil:
    ...
    def generate_batch_report(self, workspace_name, structs_ref, structs_name,
                              pdb_infos, failed_pdbs):
        """
            generate_batch_report: generate summary report for batch upload
        """
        # logging.info(f'Entering PDBUtil.generate_batch_report...with rcsb={rcsb}')
        output_html_files = self.generate_html_report(pdb_infos)
    ...
    def generate_html_report(self, succ_pdb_infos):
        """
            generate_html_report: generates the HTML for the report
        """
    ...
    def saveStructures_createReport(self, structures_name, workspace_id, workspace_name,
        ...
        try:
            ...
            report_output = self.generate_batch_report(
